...
public class IfrisDocumentResource {
    ...
    public ResponseEntity<IfrisDocumentDTO> createIfrisDocument(@Valid @RequestBody IfrisDocumentDTO ifrisDocumentDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/ifris-documents/" + result.getId()))
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the updated ifrisDocumentDTO,
     * or with status 400 (Bad Request) if the ifrisDocumentDTO is not valid,
     * or with status 500 (Internal Server Error) if the ifrisDocumentDTO couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    ...
    public ResponseEntity<IfrisDocumentDTO> updateIfrisDocument(@Valid @RequestBody IfrisDocumentDTO ifrisDocumentDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, ifrisDocumentDTO.getId().toString()))
            .body(result);
    }
    ...
    */
    ...
    /**
     * SEARCH  /_search/ifris-documents?query=:query : search for the ifrisDocument corresponding
     * to the query.
     *
