package io.github.ifris.files.aop.logging;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(io.github.ifris.files.repository..*)" + " || within(io.github.ifris.files.service..*)" + " || within(io.github.ifris.files.web.rest..*)")
